...
export default function PatientViewPage() {
  ...
  useEffect(() => {
    ...
    if (communicationMethod.length && maritalStatus.length && educationLevel.length && gender.length && referralSource.length && psychologicalDisorders.length) {
      fetchGeneralRegister();
    }
  }, [generalRegisterId, psychologicalDisorders, communicationMethod, maritalStatus, educationLevel, gender, referralSource]);
