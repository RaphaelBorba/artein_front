...
export default function GeneralRegister() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes = await api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/curso_aprofundamento_mindfulness/submissions", {
          params: {
    ...
    <Section title="Curso Aprofundamento em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('curso_aprofundamento_mindfulness')}
      ...
      <div className="flex w-full justify-end">
        <Button
          onClick={() => router.push('/forms/curso_aprofundamento_mindfulness')}
          type="button"
          variant="outline"
