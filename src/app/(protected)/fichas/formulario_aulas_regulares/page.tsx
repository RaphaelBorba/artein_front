...
export default function FormularioAulasRegularesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes= await  api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/formulario_aulas_regulares/submissions", {
            params: {
    ...
    <Section title="Formulário de Aulas Regulares">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('/fichas/formulario_aulas_regulares')}
      ...
      <div className="flex w-full justify-end">
        <Button
          onClick={() => router.push('/forms/formulario_aulas_regulares')}
          type="button"
          variant="outline"
