...
export default function FormularioDeAvaliacaoCursoAprofundamentoEmMindfulnessViewPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes= await  api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/formulario_de_avaliacao_curso_aprofundamento_em_mindfulness/submissions", {
            params: {
    ...
    <Section title="Formulário de Avaliação Curso Aprofundamento em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('formulario_de_avaliacao_curso_aprofundamento_em_mindfulness')}
        ...
        <Button
          onClick={() => router.push('/forms/formulario_de_avaliacao_curso_aprofundamento_em_mindfulness')}
          type="button"
          variant="outline"
