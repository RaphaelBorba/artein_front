...
export default function FormularioDeAvaliacaoCursoIntrodutorioMindfulnessPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes= await  api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/formulario_de_avaliacao_curso_introdutorio_em_mindfulness/submissions", {
            params: {
    ...
    <Section title="Formulário de Avaliação Curso Introdutório em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('/fichas/formulario_de_avaliacao_curso_introdutorio_em_mindfulness')}
      ...
      <div className="flex w-full justify-end">
        <Button
          onClick={() => router.push('/forms/formulario_de_avaliacao_curso_introdutorio_em_mindfulness')}
          type="button"
          variant="outline"
