...
export default function FormularioDeAvaliacaoP8sMindfulness() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes= await  api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/formulario_de_avaliacao_p8s_mindfulness/submissions", {
            params: {
    ...
    <Section title="Formulário de Avaliação P8S em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('formulario_de_avaliacao_p8s_mindfulness')}
        ...
        <Button
          onClick={() => router.push('/forms/formulario_de_avaliacao_p8s_mindfulness')}
          type="button"
          variant="outline"
