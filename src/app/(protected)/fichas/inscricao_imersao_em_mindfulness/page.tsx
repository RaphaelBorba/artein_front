...
export default function GeneralRegister() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes = await api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/inscricao_imersao_em_mindfulness/submissions", {
          params: {
    ...
    <Section title="Inscrição em Imersão em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('inscricao_imersao_em_mindfulness')}
      ...
      <div className="flex w-full justify-end">
        <Button
          onClick={() => router.push('/forms/inscricao_imersao_em_mindfulness')}
          type="button"
          variant="outline"
