...
export default function GeneralRegister() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      toggleLoader(true);
      try {
        const formsRes= await  api.get<IDataTableResposne<SubmissionRecord[]>>("/forms/p8s_em_mindfulness/submissions", {
            params: {
    ...
    <Section title="P8S em Mindfulness">
      ...
      <div className="overflow-x-auto">
        <DataTable<SubmissionRecord, unknown>
          data={forms}
          columns={getColumns('p8s_em_mindfulness')}
        ...
        <Button
          onClick={() => router.push('/forms/p8s_em_mindfulness')}
          type="button"
          variant="outline"
