...
export default function FormularioDeAvaImersaoEmMindfulnessPage() {
    ...
    async function onSubmit(values: FormularioDeAvaImersaoEmMindfulnessFormSchemaType) {
        toggleLoader(true);
        try {
            const payload = {
                formSlug: "formulario_de_ava_imersao_em_mindfulness",
                data: values,
            };
    ...
    return (
        <div className="flex justify-center sm:p-10">
            <div className="p-10 bg-white rounded-lg">
                <h1 className="text-2xl font-bold text-black mb-5">Formulário de Ava Imersão em Mindfulness</h1>
                {wasSubmitted ? (
