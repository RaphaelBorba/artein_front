...
export default function FormularioDeAvaliacaoCursoIntrodutorioMindfulnessPage() {
    ...
    async function onSubmit(values: FormularioDeAvaliacaoCursoIntrodutorioMindfulnessFormSchemaType) {
        toggleLoader(true);
        try {
            const payload = {
                formSlug: "formulario_de_avaliacao_curso_introdutorio_em_mindfulness",
                data: values,
            };
    ...
    return (
        <div className="flex justify-center sm:p-10">
            <div className="p-10 bg-white rounded-lg">
                <h1 className="text-2xl font-bold text-black mb-5">Formulário de Avaliação Curso Introdutório em Mindfulness</h1>
                {wasSubmitted ? (
