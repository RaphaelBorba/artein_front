...
export default function FormularioDeAvaliacaoP8SMindfulnessViewPage() {
    ...
    async function onSubmit(values: FormularioDeAvaliacaoP8sMindfulnessFormSchemaType) {
        toggleLoader(true);
        try {
            const payload = {
                formSlug: "formulario_de_avaliacao_p8s_mindfulness",
                data: values,
            };
    ...
    return (
        <div className="flex justify-center sm:p-10">
            <div className="p-10 bg-white rounded-lg">
                <h1 className="text-2xl font-bold text-black mb-5">Formulário de Avaliação P8S em Mindfulness</h1>
                {wasSubmitted ? (
