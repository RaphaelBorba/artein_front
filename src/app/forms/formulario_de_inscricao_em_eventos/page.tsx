...
export default function FormularioDeInscricaoEmEventosPage() {
    ...
    async function onSubmit(values: FormularioDeInscricaoEmEventosFormSchemaType) {
        toggleLoader(true);
        try {
            const payload = {
                formSlug: "formulario_de_inscricao_em_eventos",
                data: values,
            };
    ...
    return (
        <div className="flex justify-center sm:p-10">
            <div className="p-10 bg-white rounded-lg">
                <h1 className="text-2xl font-bold text-black mb-5">Formulário de Inscrição em Eventos</h1>
                {wasSubmitted ? (
