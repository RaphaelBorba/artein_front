...
export const inscricaoImersaoEmMindfulnessSchema = z.object({
    ...
    alreadyParticipatedInCourseArtin: z.string().optional(),
    alreadyParticipatedInCourseOther: z.string().optional(),
...
export type InscricaoImersaoEmMindfulnessFormSchemaType = z.infer<typeof inscricaoImersaoEmMindfulnessSchema>;